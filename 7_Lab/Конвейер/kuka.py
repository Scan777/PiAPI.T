...
class Kuka:   
    ...
    def set_speed(self, value):
        time.sleep(0.05)
        self.robot.write("COM_VALUE", str(value), False)
    ...
    def open_grip(self):
        time.sleep(0.05)
        self.robot.write('OUT1', 'False')
        self.robot.write('OUT2', 'True')
    ...
    def close_grip(self):
        time.sleep(0.05)
        self.robot.write('OUT1', 'True')
        self.robot.write('OUT2', 'False')
        self.robot.write("COM_CASEVAR", "7", False)
        while int(self.robot.read("COM_CASEVAR", False).decode())!=0:
            continue        
